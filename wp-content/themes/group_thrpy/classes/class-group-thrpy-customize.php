...
if ( ! class_exists( 'Twenty_Twenty_One_Customize' ) ) {
	...
	class Twenty_Twenty_One_Customize {
		...
		public function register( $wp_customize ) {
			...
			include_once get_theme_file_path( 'classes/class-group-thrpy-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
