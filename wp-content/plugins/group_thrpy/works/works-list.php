    ...
    <div class="wrap work_list_div">
        ...
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { 
                    ...
                    $directors = $wpdb->get_results("SELECT * from $table_name_director");
                    // $arr_directors = array();
                    $director = "";
                    foreach($directors as $d_val){
                        if($d_val->id == $row->director){
                            $director = $d_val->s_id;
                        }
                    }
                ...
                <tr>
                    ...
                    <td class="manage-column ss-list-width"><?php echo $director; ?></td>
                    ...
                    <td class="manage-column ss-list-width"><?php echo $row->ma2nicurist; ?></td>
